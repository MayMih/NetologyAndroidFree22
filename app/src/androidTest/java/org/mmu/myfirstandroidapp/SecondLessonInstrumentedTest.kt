...
class SecondLessonInstrumentedTest {
    ...
    fun testToolbarMenuItemStopHasDrawable() {
        onView(
            ...
            matches(
                menuItemWithBackgroundDrawable(R.drawable.baseline_stop_circle_24)
            )
        )
    }
    ...
    fun testToolbarMenuItemClearHasDrawable() {
        onView(
            ...
            matches(
                menuItemWithBackgroundDrawable(R.drawable.baseline_clear_all_24)
            )
        )
    }
    ...
    fun testFabHasDrawable() {
        onView(
            ...
            matches(
                withDrawable(R.drawable.baseline_keyboard_voice_24)
            )
        )
    }
